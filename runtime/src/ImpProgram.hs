...
ind_3 = regularParse runtime "2**[f == 3*x + 5/2] ** (w ++ 1)" -- antes fallaba: el viejo "<>" sólo aceptaba un aexp como peso, y "w ++ 1" es un runtime compuesto. Con "**" genérico esto ya parsea.
